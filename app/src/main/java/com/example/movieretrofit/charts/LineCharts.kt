...
class LineCharts {
    ...
    private fun settingsLineChart(
        ...
        lineChart.isDoubleTapToZoomEnabled = false // Prevent zooming by the user
        lineChart.setScaleEnabled(false) // Prevent scaling by the user
    ...
    private fun settingsDataSet(
        ...
        dataSet.cubicIntensity = 0.1f // Curvature adjustment
        dataSet.color = color
