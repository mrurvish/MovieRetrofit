...
class HomeFragment : Fragment() {
    ...
    private fun onClickCal() {
        binding.tvCalories.setOnClickListener {
            Toast.makeText(context, "Consumed calories", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun setCalendar() {
        ...
        val monthNames = Month.values().map { month ->
            month.getDisplayName(TextStyle.FULL_STANDALONE, Locale("en"))
    ...
    private fun setDataToTextView() {
        ...
        val proteinText = "Proteins: ${nutrients.protein.roundToInt()} G"
        val fatText = "Fats: ${nutrients.fat.roundToInt()} G"
        val carbText = "Carbohydrates: ${nutrients.carb.roundToInt()} G"
